...
const AllSkills = () => {
    ...
    return (
        <section className="min-h-screen bg-gradient-to-b from-gray-100 to-gray-50 py-16 px-6">
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 p-4">
                {filteredSkills.map((skill, idx) => (
                    <motion.div
                        key={idx}
                        className="bg-white rounded-3xl shadow-2xl p-6 flex flex-col items-center text-center hover:scale-100 transform transition-transform duration-300 relative"
