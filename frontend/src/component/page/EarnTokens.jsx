        ...
        <section className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-200 py-16 px-6">
            ...
            <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto mb-16">
                ...
                <div className="bg-white p-6 rounded-2xl shadow text-center">
                    ...
                    <p className="text-gray-500 text-sm">Tokens Earned by Community</p>
                </div>
                ...
                <div className="bg-white p-6 rounded-2xl shadow text-center">
                    ...
                    <p className="text-gray-500 text-sm">Skill Challenges Completed</p>
                </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
                ...
                {earnOptions.map((option, index) => (
                    ...
                    <motion.div
                        ...
                        className="bg-white rounded-3xl shadow-lg p-6 cursor-pointer transition"
                    >
